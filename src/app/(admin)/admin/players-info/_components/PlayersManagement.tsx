...
import { playersData, usersData } from '@/data/dummy.data';
                    ...
                    <div className="flex flex-col md:flex-row gap-2">
                        <div className="shrink-0 inline-block w-12 h-12">
                            <Image
                                ...
                                src={data.player_image || 'https://placehold.co/100x100/e2e2db/red/png'}
                        ...
                        <p className="line-clamp-2 text-w-paragraph-regular-20">{data.player_name}</p>
                    </div>
                </div>
            ),
        },
            ...
            <div className='space-y-5'>
                <div className="flex space-x-4 mb-4">
                    <button
                        ...
                        className={`px-5 rounded-full py-1.5 ${selectedRole === "" ? "bg-c-violet-500 text-white" : "bg-c-grey-50"
                            }`}
                    >
                        All
                    </button>
                    <button
                        ...
                        className={`px-5 rounded-full py-1.5 ${selectedRole === "BATSMAN" ? "bg-c-violet-500 text-white" : "bg-c-grey-50"
                            }`}
                    >
                        Batsman
                    </button>
                    <button
                        ...
                        className={`px-5 rounded-full py-1.5 ${selectedRole === "BOWLER" ? "bg-c-violet-500 text-white" : "bg-c-grey-50"
                            }`}
                    >
                        Bowler
                    </button>
