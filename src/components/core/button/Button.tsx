...
export const buttonVariants = cva('leading-none text-white transition-all disabled:bg-slate-300', {
    variants: {
        variant: {
            ...
            roundedOutlineBtn:
                'rounded-[200px] border border-c-violet-500 text-c-violet-500 text-xs px-[18px] py-[10px] md:text-[15px] bg-none  hover:border-c-violet-100 text-c-violet-100   md:px-6 md:py-3 xl:px-8 xl:py-3.5 xl:text-[16px]',
            regulerBtn:
